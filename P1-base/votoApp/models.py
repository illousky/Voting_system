...
class ProcesoElectoral(models.Model):
    """Definición del modelo para representar un proceso electoral"""
    
    idProcesoElectoral = models.CharField(max_length=16, primary_key=True)
    nombreProcesoElectoral = models.CharField(max_length=128)
    fechaInicio = models.DateTimeField()
    fechaFin = models.DateTimeField()
    
    def __str__(self):
        return f"{self.nombreProcesoElectoral} ({self.idProcesoElectoral})"
